...
public class MatriculaHandler {
    ...
    public MatriculaHandler(MatriculaService service) { this.service = service; }
    ...
    public MatriculaDTO registrar(String authorization, MatriculaCreateDTO dto) { return service.registrar(authorization, dto); }
